...
/** 
 * This class represents the primary key of the bill table.
 */
public class BillPk implements Serializable
{
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof BillPk)) {
			return false;
		}
		
		final BillPk _cast = (BillPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.mybillr.db.dto.BillPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
