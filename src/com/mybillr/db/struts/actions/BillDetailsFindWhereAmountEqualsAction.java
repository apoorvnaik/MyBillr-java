...
public class BillDetailsFindWhereAmountEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			long _amount = Long.parseLong( request.getParameter("amount") );
		
			// create the DAO class
			BillDetailsDao dao = BillDetailsDaoFactory.create();
		
			// execute the finder
			BillDetails dto[] = dao.findWhereAmountEquals(_amount);
