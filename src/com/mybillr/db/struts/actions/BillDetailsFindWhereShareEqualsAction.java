...
public class BillDetailsFindWhereShareEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			long _share = Long.parseLong( request.getParameter("share") );
		
			// create the DAO class
			BillDetailsDao dao = BillDetailsDaoFactory.create();
		
			// execute the finder
			BillDetails dto[] = dao.findWhereShareEquals(_share);
