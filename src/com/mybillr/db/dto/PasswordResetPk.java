...
/** 
 * This class represents the primary key of the password_reset table.
 */
public class PasswordResetPk implements Serializable
{
	 ...
	 * @param id
	 */
	public PasswordResetPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof PasswordResetPk)) {
			return false;
		}
		
		final PasswordResetPk _cast = (PasswordResetPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.mybillr.db.dto.PasswordResetPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
